...
public class SegmentedGroup extends RadioGroup {
	...
	public SegmentedGroup(Context context) {
		...
		mUnCheckedTintColor = resources
				.getColor(R.color.radio_button_unselected_color);
	...
	private void initAttrs(AttributeSet attrs) {
		...
		try {
			mMarginDp = (int) typedArray.getDimension(
					R.styleable.SegmentedGroup_sc_border_width, getResources()
							.getDimension(R.dimen.radio_button_stroke_border));

			mCornerRadius = typedArray.getDimension(
					R.styleable.SegmentedGroup_sc_corner_radius, getResources()
							.getDimension(R.dimen.radio_button_conner_radius));

			mTintColor = typedArray.getColor(
					R.styleable.SegmentedGroup_sc_tint_color, getResources()
			...
			mUnCheckedTintColor = typedArray.getColor(
					...
					getResources().getColor(
							R.color.radio_button_unselected_color));
		} finally {
			typedArray.recycle();
		}
	}
	...
	public void setUnCheckedTintColor(int unCheckedTintColor,
	...
	private void updateBackground(View view) {
		...
		ColorStateList colorStateList = new ColorStateList(new int[][] {
				...
				{ android.R.attr.state_checked } }, new int[] { mTintColor,
				mCheckedTextColor });
		...
		GradientDrawable maskDrawable = (GradientDrawable) resources
		...
		int maskColor = Color.argb(50, Color.red(mTintColor),
				Color.green(mTintColor), Color.blue(mTintColor));
		maskDrawable.setColor(maskColor);
		LayerDrawable pressedDrawable = new LayerDrawable(new Drawable[] {
				uncheckedDrawable, maskDrawable });
