...
public class TypefaceProvider {
    ...
    private final static Map<CharSequence, Typeface> TYPEFACE_MAP = new HashMap<CharSequence, Typeface>();
    private final static Map<CharSequence, IconSet> REGISTERED_ICON_SETS = new HashMap<CharSequence, IconSet>();
