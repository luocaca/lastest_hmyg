...
//						Toast.LENGTH_SHORT).show();
				...
				intent.putExtra("decodeResult", msg.obj.toString());
				activityReference.get().setResult(2, intent);
...
//				Toast.LENGTH_SHORT).show();
		...
		Intent intent = new Intent();
		intent.putExtra("decodeResult", ResultParser.parseResult(rawResult).toString());
		setResult(2, intent);
		finish();
