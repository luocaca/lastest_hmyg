...
/** 下拉刷新的头部控件  */
@SuppressLint("NewApi") public class PRTHeader extends LinearLayout {
	...
	@TargetApi(Build.VERSION_CODES.HONEYCOMB) public void onPullDown(int percent) {
		if (percent > 100) {
	...
	@TargetApi(Build.VERSION_CODES.HONEYCOMB) public void onRequest() {
	...
	@SuppressLint("NewApi") public void reverse() {
		pbRefreshing.setVisibility(View.GONE);
