...
import com.hldj.hmyg.adapter.BrokerProductListAdapter;
...
public class BrokerListDetailActivity extends NeedSwipeBackActivity implements
		IXListViewListener {
	private XListView xListView;
	private ArrayList<HashMap<String, Object>> datas = new ArrayList<HashMap<String, Object>>();

	boolean getdata; // 避免刷新多出数据
	private BrokerProductListAdapter listAdapter;
	...
	private void initData() {
		...
		finalHttp.post(GetServerUrl.getUrl()
				+ "admin/agent/validateApply/listItems", params,
				new AjaxCallBack<Object>() {
						...
						try {
							...
							if ("1".equals(code)) {
								...
								if (JsonGetInfo.getJsonArray(jsonObject2,
									...
									if (listAdapter == null) {
										listAdapter = new BrokerProductListAdapter(
												BrokerListDetailActivity.this,
												datas);
					...
					public void onFailure(Throwable t, int errorNo,
							String strMsg) {
						// TODO Auto-generated method stub
						Toast.makeText(BrokerListDetailActivity.this,
	...
	public void onRefresh() {
		...
		if (listAdapter == null) {
			listAdapter = new BrokerProductListAdapter(
					BrokerListDetailActivity.this, datas);
