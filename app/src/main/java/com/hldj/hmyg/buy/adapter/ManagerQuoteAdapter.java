...
public class ManagerQuoteAdapter extends BaseAdapter {
	...
	public ManagerQuoteAdapter(Context context, ArrayList<ManagerPurchase> data) {
		this.data = data;
	...
	public View getView(final int position, View convertView, ViewGroup parent) {
		...
		ll_daifahuo_00 = (BGABadgeLinearLayout) inflate
		...
		inflate.setOnClickListener(new OnClickListener() {
			...
			public void onClick(View v) {
				...
				// 报价管理列表
				Intent toManagerQuoteListActivity = new Intent(context,
						ManagerQuoteListActivity.class);
				toManagerQuoteListActivity.putExtra("name", data.get(position)
						.getName());
				toManagerQuoteListActivity.putExtra("status", data
						.get(position).getStatus());
				context.startActivity(toManagerQuoteListActivity);
