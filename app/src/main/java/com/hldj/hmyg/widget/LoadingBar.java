...
public class LoadingBar extends Dialog {
	...
	public static LoadingBar getInstance(Context context) {
		if (instance == null) {
			instance = new LoadingBar(context);
		}
		return instance;
	}

	public LoadingBar(Context context) {
		super(context, com.hldj.hmyg.R.style.DialogTheme);
...
//		}
	...
	public void dismissWithSuccess(String message, int sleepTime) {
		showSuccessImage();
		if (message != null) {
			tvMessage.setText(message);
		} else {
		...
		dismissHUD(sleepTime);
	}

	public void dismissWithFailure(String message, int sleepTime) {
		showFailureImage();
		if (message != null) {
			tvMessage.setText(message);
		} else {
	 ...
	 * @param drawable
	 */
	public void dismissWithFailureTeam(String message, int drawable) {
		showFailureImage();
		if (message != null) {
			tvMessage.setText(message);
			ivFailure.setImageResource(drawable);
		} else {
			tvMessage.setText("");
		}
		if (onDialogDismiss != null) {
	...
	protected void dismissHUD(final int sleepTime) {
