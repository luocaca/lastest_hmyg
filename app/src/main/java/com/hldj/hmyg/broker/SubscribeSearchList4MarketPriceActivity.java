...
public class SubscribeSearchList4MarketPriceActivity extends Activity {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		setContentView(R.layout.activity_subscribe_search_list_for_market);
	...
	private void initData(String name) {
		...
		finalHttp.post(GetServerUrl.getUrl()
				+ "seedlingMarket/seedlingType/search", params,
								...
								if (datas.size() > 0) {
									if (listAdapter == null) {
										listAdapter = new MapSearchAdapter(
												SubscribeSearchList4MarketPriceActivity.this,
												datas);
