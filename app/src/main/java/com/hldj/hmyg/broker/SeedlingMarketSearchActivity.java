...
public class SeedlingMarketSearchActivity extends Activity {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		setContentView(R.layout.activity_seedling_market_search);
		...
		if (getIntent().getStringExtra("name") != null) {
			initData(getIntent().getStringExtra("name"));
			et_search.setText(getIntent().getStringExtra("name"));
		}
	...
	private void initData(String name) {
		...
		finalHttp.post(GetServerUrl.getUrl() + "seedlingMarket/search", params,
								...
								if (datas.size() > 0) {
									if (listAdapter == null) {
										listAdapter = new MapSearchAdapter(
												SeedlingMarketSearchActivity.this,
												datas);
		...
		public View getView(final int position, View convertView,
			...
			inflate.setOnClickListener(new OnClickListener() {
				...
				public void onClick(View v) {
					...
					// bundleObject.putSerializable("Subscribe",
					// data.get(position));
					...
					public void onSuccess(Object t) {
						...
						try {
							...
							if ("1".equals(code)) {
								...
								Toast.makeText(
										SeedlingMarketSearchActivity.this, msg,
