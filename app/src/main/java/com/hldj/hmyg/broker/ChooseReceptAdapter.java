...
public class ChooseReceptAdapter extends BaseAdapter {
	...
	public ChooseReceptAdapter(ArrayList<ReceiptListJson> list, Context context) {
	...
	public View getView(int position, View convertView, ViewGroup arg2) {
		...
		if (convertView == null) {
			convertView = LayoutInflater.from(context).inflate(
					R.layout.listrow_item_choose_recept, null);
		...
		holder.et_number.setHint("可装："+(list.get(position).getCount()-list.get(position).getLoadedCountJson()));
