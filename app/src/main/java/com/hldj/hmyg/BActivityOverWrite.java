 ...
 */
@SuppressLint("NewApi")
public class BActivityOverWrite extends BaseSecondActivity implements
		IXListViewListener,
		PLAXListView.IXListViewListener,
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		setContentView(R.layout.activity_b_bak);
		hud = KProgressHUD.create(BActivityOverWrite.this)
		...
		tabs.setOnPageChangeListener(new OnPageChangeListener() {
			...
			public void onPageSelected(int arg0) {
				...
				if ("".equals(lanmu_ids.get(arg0))) {
					...
					Intent toWeituoActivity = new Intent(BActivityOverWrite.this,
...
//						ll_01.setVisibility(View.VISIBLE);
		...
		finalHttp.post(GetServerUrl.getUrl() + "seedlingType/getFirstType",
				params, new AjaxCallBack<Object>() {
					...
					public void onFailure(Throwable t, int errorNo,
						...
						Toast.makeText(BActivityOverWrite.this, R.string.error_net,
		...
		public void onClick(View view) {
			if (flag) {
				...
				case R.id.rl_choose_screen:
					Intent toSellectActivity = new Intent(BActivityOverWrite.this,
				...
				case R.id.RelativeLayout2:
					Intent intent = new Intent(BActivityOverWrite.this,
						...
						finalHttp.post(GetServerUrl.getUrl()
								...
								new AjaxCallBack<Object>() {
									...
									public void onFailure(Throwable t,
										...
										Toast.makeText(BActivityOverWrite.this,
												R.string.error_net,
												Toast.LENGTH_SHORT).show();
										super.onFailure(t, errorNo, strMsg);
									}
	...
	private void showCitys() {
		...
		tv_sure.setOnClickListener(new OnClickListener() {
			...
			public void onClick(View v) {
				...
				cityCode = GetCodeByName.initProvinceDatas(BActivityOverWrite.this,
						mCurrentProviceName, mCurrentCityName);
				onRefresh();
				// tv_area.setText(cityName);
				if (!BActivityOverWrite.this.isFinishing() && dialog != null) {
					if (dialog.isShowing()) {
						dialog.cancel();
					} else {
						dialog.show();
		...
		if (!BActivityOverWrite.this.isFinishing() && dialog.isShowing()) {
			dialog.cancel();
		} else if (!BActivityOverWrite.this.isFinishing() && dialog != null
				&& !dialog.isShowing()) {
			dialog.show();
		}
	}
	...
	private void setUpData() {
		...
		mViewProvince.setViewAdapter(new ArrayWheelAdapter<String>(
				BActivityOverWrite.this, mProvinceDatas));
		// 设置可见条目数量
