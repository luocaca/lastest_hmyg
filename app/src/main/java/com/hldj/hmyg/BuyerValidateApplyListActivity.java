...
import com.hldj.hmyg.adapter.BuyerListAdapter;
...
public class BuyerValidateApplyListActivity extends NeedSwipeBackActivity implements IXListViewListener {
	private XListView xListView;
	private ArrayList<HashMap<String, Object>> datas = new ArrayList<HashMap<String, Object>>();

	boolean getdata; // 避免刷新多出数据
	private BuyerListAdapter listAdapter;
		...
		finalHttp.post(
				...
				params, new AjaxCallBack<Object>() {
					...
					public void onSuccess(Object t) {
						...
						try {
							...
							String msg = JsonGetInfo.getJsonString(jsonObject,
									"msg");
							if (!"".equals(msg)) {
								Toast.makeText(BuyerValidateApplyListActivity.this, msg,
								...
								if (JsonGetInfo.getJsonArray(jsonObject2,
									...
									if (jsonArray.length() > 0) {
										for (int i = 0; i < jsonArray.length(); i++) {
											...
											hMap.put("acceptStatus", acceptStatus);
										...
										if (listAdapter == null) {
											listAdapter = new BuyerListAdapter(
													BuyerValidateApplyListActivity.this,
													datas);
					...
					public void onFailure(Throwable t, int errorNo,
							String strMsg) {
						// TODO Auto-generated method stub
						Toast.makeText(BuyerValidateApplyListActivity.this,
	...
	public void onRefresh() {
		...
		datas.clear();
		if (listAdapter == null) {
			listAdapter = new BuyerListAdapter(BuyerValidateApplyListActivity.this, datas);
			xListView.setAdapter(listAdapter);
		} else {
