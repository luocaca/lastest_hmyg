...
@SuppressLint("NewApi")
public class MiaoNoteListActivity extends BaseSecondActivity implements
		IXListViewListener,
	...
	public void onRefresh() {
		...
		datas.clear();
		if (listAdapter == null) {
			listAdapter = new MiaoNoteListAdapter(MiaoNoteListActivity.this,
					datas);
						...
						try {
							...
							if ("1".equals(code)) {
								...
								if (JsonGetInfo.getJsonArray(jsonObject2,
									...
									if (listAdapter == null) {
										listAdapter = new MiaoNoteListAdapter(
												MiaoNoteListActivity.this,
												datas);
										xListView.setAdapter(listAdapter);
