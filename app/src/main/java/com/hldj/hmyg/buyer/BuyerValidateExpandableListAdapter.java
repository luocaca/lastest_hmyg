 ...
 */
public class BuyerValidateExpandableListAdapter extends
	...
	public BuyerValidateExpandableListAdapter(Context context,
			List<Map<String, Object>> parentMapList,
			List<List<Map<String, Object>>> childMapList_list) {
	...
	public View getChildView(final int groupPosition, final int childPosition,
		...
		} else if ("unaccept".equals(parentMapList.get(groupPosition)
				.get("acceptStatus").toString())) {
			childViewHolder.tv_status.setTextColor(Data.STATUS_BLUE);
		} else if ("verifing".equals(parentMapList.get(groupPosition)
				.get("acceptStatus").toString())) {
			childViewHolder.tv_status.setTextColor(Data.STATUS_GREEN);
		} else if ("verifyed".equals(parentMapList.get(groupPosition)
				.get("acceptStatus").toString())) {
			childViewHolder.tv_status.setTextColor(Data.STATUS_ORANGE);
		} else if ("ordered".equals(parentMapList.get(groupPosition)
				.get("acceptStatus").toString())) {
