...
public class BuyerValidateApplyActivity extends NeedSwipeBackActivity implements
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		setContentView(R.layout.activity_buyer_validate);
		gson = new Gson();
		onRefresh1();
		// initData();
		// initCartData();
	...
	public void initView() {
		...
		expandableListView
				.setOnItemClickListener(new AdapterView.OnItemClickListener() {
					...
					public void onItemClick(AdapterView<?> parent, View view,
						...
						Toast.makeText(BuyerValidateApplyActivity.this,
		...
		id_iv_back.setOnClickListener(new View.OnClickListener() {
			...
			public void onClick(View v) {
				Toast.makeText(BuyerValidateApplyActivity.this, "click :back",
		...
		id_tv_save_star_all.setOnClickListener(new View.OnClickListener() {
			@Override
			public void onClick(View v) {
				Toast.makeText(BuyerValidateApplyActivity.this, "收藏多选商品",
						Toast.LENGTH_SHORT).show();
			}
		});
				...
				if (parentMapList_tocheck.size() > 0
					...
					if ("unpay".equals(acceptStatus)) {
						Intent intent = new Intent(
								BuyerValidateApplyActivity.this,
						...
						for (int i = 0; i < parentMapList_tocheck.size(); i++) {
							...
							for (int j = 0; j < list.size(); j++) {
								...
								orderPreSaves.add(new OrderPreSave(list.get(j)
										...
										goodsBean.getCount()));
//								saveForCarts.add(new saveForCart(parentMapList_tocheck
...
//										.getCount(), "proxy"));
						...
						preSave(num, gson.toJson(orderPreSaves),gson.toJson(saveForCarts),
								cartIds.toString());
					}
	...
	public void preSave(final int num, final String orderPreSaves,final String str_itemData,final String cartIds) {
					...
					public void onSuccess(Object t) {
						...
						try {
							...
							if ("1".equals(code) && !jsonObject.isNull("data")) {
								// 传递值到下单页面
								// 已验苗去下单
								Intent intent = new Intent(BuyerValidateApplyActivity.this,
	...
	private void initCartData() {
		...
		params.put("itemStatus", acceptStatus);
		finalHttp.post(
