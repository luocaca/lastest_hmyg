...
public class ThematicDetailAdapter extends BaseAdapter {
	private static final String TAG = "ThematicDetailAdapter";
	...
	public ThematicDetailAdapter(Context context,
	...
	public View getView(final int position, View convertView, ViewGroup parent) {
		...
		if(data.get(position).get("freeValidate").toString()
				.contains("true")){
		...
		tv_09.setText(data.get(position).get("ciCity_name").toString());
