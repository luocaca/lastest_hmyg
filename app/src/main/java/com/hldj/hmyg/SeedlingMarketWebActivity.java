...
public class SeedlingMarketWebActivity extends NeedSwipeBackActivity {
	private WebView webview;
	private TextView tv_loading;
	private ProgressBar bar;
	private String url = "http://m.hmeg.cn/seedlingMarket/list/";
	...
	class MyWebChromeClient extends WebChromeClient {
		...
		public boolean onJsAlert(WebView view, String url, String message,
				JsResult result) {
			Toast.makeText(SeedlingMarketWebActivity.this, message,
	...
	private void addImageClickListner() {
		...
		webview.loadUrl("javascript:(function(){" + "ProxyBridge.callback();"
				+ "})()");
	}
