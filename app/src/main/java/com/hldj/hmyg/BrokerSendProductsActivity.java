...
public class BrokerSendProductsActivity extends NeedSwipeBackActivity implements
		IXListViewListener {
								...
								if (JsonGetInfo.getJsonArray(jsonObject2,
									...
									if (listAdapter == null) {
										listAdapter = new BrokerSendProductListAdapter(
												BrokerSendProductsActivity.this,
												datas);
	...
	public void onRefresh() {
		...
		if (listAdapter == null) {
			listAdapter = new BrokerSendProductListAdapter(
					BrokerSendProductsActivity.this, datas);
