...
public class FrontViewToMove {
	...
	private int xToMove;// 视图所要被移动的距离，默认200
	 ...
	 *            所要滑动的视图
	 */
	public FrontViewToMove(View frontView, Context context) {
	 ...
	 *            所要滑动的视图的容器
	 */
	public FrontViewToMove(View frontView, ListView listView, Context context) {
		this.frontView = frontView;
