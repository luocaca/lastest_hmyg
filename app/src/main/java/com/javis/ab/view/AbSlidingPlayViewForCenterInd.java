...
public class AbSlidingPlayViewForCenterInd extends LinearLayout {
	 ...
	 * @param context
	 */
	public AbSlidingPlayViewForCenterInd(Context context) {
		super(context);
		initView(context);
	}
	 ...
	 *            the attrs
	 */
	public AbSlidingPlayViewForCenterInd(Context context, AttributeSet attrs) {
		super(context, attrs);
		initView(context);
	}
