...
public class GetValidatePriceCustomDialog2 extends Dialog {

	public GetValidatePriceCustomDialog2(Context context) {
		super(context);
	}

	public GetValidatePriceCustomDialog2(Context context, int theme) {
		super(context, theme);
	}
	...
	public static class Builder {
		...
		public GetValidatePriceCustomDialog2 create() {
			LayoutInflater inflater = (LayoutInflater) context
					.getSystemService(Context.LAYOUT_INFLATER_SERVICE);
			// instantiate the dialog with the custom Theme
			final GetValidatePriceCustomDialog2 dialog = new GetValidatePriceCustomDialog2(context,
					R.style.Dialog);
			View layout = inflater.inflate(R.layout.dialog_normal_layout_get_validate_price2, null);
