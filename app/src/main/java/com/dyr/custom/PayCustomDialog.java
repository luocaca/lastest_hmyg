...
public class PayCustomDialog extends Dialog {
	...
	public PayCustomDialog(Context context) {
		super(context);
	}

	public PayCustomDialog(Context context, int theme) {
		super(context, theme);
	}
	...
	public static class Builder {
		...
		public PayCustomDialog create() {
			...
			final PayCustomDialog dialog = new PayCustomDialog(context,
					R.style.Dialog);
			View layout = inflater.inflate(R.layout.dialog_normal_layout_pay, null);
