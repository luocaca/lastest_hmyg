...
public class ContactCustomDialog extends Dialog {
	...
	public ContactCustomDialog(Context context, int theme) {
		super(context, theme);
	}
	...
	public static class Builder {
		...
		public ContactCustomDialog create() {
			LayoutInflater inflater = (LayoutInflater) context
					.getSystemService(Context.LAYOUT_INFLATER_SERVICE);
			// instantiate the dialog with the custom Theme
			final ContactCustomDialog dialog = new ContactCustomDialog(context,
					R.style.Dialog);
			View layout = inflater.inflate(R.layout.dialog_normal_layout_contact, null);
