...
public class GetValidatePriceCustomDialog extends Dialog {

	public GetValidatePriceCustomDialog(Context context) {
		super(context);
	}

	public GetValidatePriceCustomDialog(Context context, int theme) {
		super(context, theme);
	}
	...
	public static class Builder {
		...
		public GetValidatePriceCustomDialog create() {
			LayoutInflater inflater = (LayoutInflater) context
					.getSystemService(Context.LAYOUT_INFLATER_SERVICE);
			// instantiate the dialog with the custom Theme
			final GetValidatePriceCustomDialog dialog = new GetValidatePriceCustomDialog(context,
					R.style.Dialog);
			View layout = inflater.inflate(R.layout.dialog_normal_layout_get_validate_price, null);
