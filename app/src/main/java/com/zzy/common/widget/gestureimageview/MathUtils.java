...
public class MathUtils {
	...
	public static float calculateCurrentRotation(float rotation) {
		float result = rotation % 360.0f;
		if (result < 0.0f) {
			result += 360.0f;
		}
		return result;
	 ...
	 * @return
	 */
	public static boolean isPortraitByDegree(float degree) {
		return (((int) degree) / 90) % 2 == 0;
	}
}
